  ...
  return (
    <section className="mt-8" aria-label="Notes">
      ...
      <textarea
        ...
        rows={2}
        placeholder="—"
        className="min-h-11 w-full resize-none rounded-card border border-transparent bg-transparent px-0 py-2 font-serif text-ink placeholder:text-ink-faint focus:border-line focus:bg-bg-alt focus:px-3"
      />
